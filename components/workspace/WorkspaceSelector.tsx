...
export default function WorkspaceSelector() {
  ...
  const { workspaces, currentWorkspace, setCurrentWorkspace, createNewWorkspace, updateWorkspace, isLoading, error } = useWorkspace();
  ...
  return (
    <div className="relative">
      {showEditForm ? (
        ...
        >
          {/* User Avatar */}
          <div className="w-10 h-10 bg-[#2a2a2a]/60 rounded-full flex items-center justify-center text-lg font-semibold text-[#e5e5e5] group-hover:scale-110 transition-transform duration-300">
              ...
              Object.entries(groupedWorkspaces).map(([email, emailWorkspaces]) => (
                <div key={email} className="mb-4 last:mb-0">
                  ...
                  {emailWorkspaces.map((workspace) => (
                    ...
                    >
                      <div className="w-8 h-8 bg-[#2a2a2a]/60 rounded-md flex items-center justify-center text-sm font-semibold">
      ...
      {showInviteModal && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            <div className="bg-[#1a1a1a]/95 border border-[#2a2a2a]/60 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] w-full max-w-md backdrop-blur-xl">
