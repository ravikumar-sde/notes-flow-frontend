  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div className="bg-[#1a1a1a]/95 border border-[#2a2a2a]/60 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] w-full max-w-5xl h-[85vh] backdrop-blur-xl flex overflow-hidden">
          {/* Sidebar */}
          <div className="w-64 bg-[#0f0f0f]/50 border-r border-[#2a2a2a]/60 p-4 overflow-y-auto">
            {/* Account Section */}
            <div className="mb-6">
              <div className="text-xs text-[#6b6b6b] px-3 py-2 font-semibold tracking-wider">
                ACCOUNT
              </div>
              <button
