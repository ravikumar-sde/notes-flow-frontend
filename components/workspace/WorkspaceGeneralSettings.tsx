...
export default function WorkspaceGeneralSettings() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      {/* Workspace Icon */}
      <div>
        <h3 className="text-md font-semibold text-[#e5e5e5] mb-4">Workspace icon</h3>
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 bg-[#2a2a2a]/60 rounded-lg flex items-center justify-center text-2xl font-semibold text-[#e5e5e5]">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-3 py-2 bg-[#1f1f1f]/80 text-[#e5e5e5] border border-[#2a2a2a]/60 rounded-lg outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all resize-none"
      ...
      <div className="border-t border-[#2a2a2a]/60 pt-6">
        <button
          ...
          className="px-6 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
        >
          {isSaving && (
      ...
      <div className="border-t border-[#2a2a2a]/60 pt-6">
        ...
        <div className="p-4 bg-red-900/10 border border-red-500/20 rounded-lg">
          <div className="flex items-start justify-between">
            <div>
              <h4 className="text-sm font-semibold text-[#e5e5e5] mb-1">Delete workspace</h4>
        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-60 p-4">
            <div className="bg-[#1a1a1a]/95 border border-red-500/30 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] w-full max-w-md backdrop-blur-xl p-6">
              <h3 className="text-lg font-semibold text-red-400 mb-2">Delete Workspace</h3>
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => setShowDeleteConfirm(false)}
                  disabled={isDeleting}
                  className="flex-1 px-4 py-2.5 bg-[#2a2a2a]/80 text-[#e5e5e5] rounded-lg font-medium hover:bg-[#3a3a3a]/80 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
              </div>
