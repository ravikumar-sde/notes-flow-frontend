    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-6 py-12 relative">
      ...
      <div className="w-full max-w-md relative z-10">
        <Link href="/" className="flex items-center justify-center gap-3 mb-12">
          ...
          <span className="text-2xl font-bold text-white">NotesFlow</span>
        </Link>
        ...
        <div className="border border-white/10 rounded-3xl p-10">
          ...
          <p className="text-white/40 mb-10">Start your journey with NotesFlow</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-white/30 transition-all"
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="w-4 h-4 mt-1 bg-[#0f0f0f] border-[#2a2a2a] rounded text-[#6366f1] focus:ring-[#6366f1]/20"
              />
              <label htmlFor="terms" className="ml-2 text-sm text-[#a0a0a0]">
                I agree to the{' '}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full px-6 py-4 bg-white text-black rounded-xl hover:bg-white/90 transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed mt-8"
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-3 px-4 py-3 border border-white/10 rounded-xl hover:bg-white/5 transition-all">
        ...
        <p className="text-center mt-8 text-white/40">
          ...
          <Link href="/auth/login" className="text-white hover:underline font-medium">Sign in</Link>
        </p>
      </div>
    </div>
  );
